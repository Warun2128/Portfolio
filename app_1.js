...
const projectData = {
  1: {
    ...
    keyFindings: [
      ...
      "Cost savings potential of $2.3M through targeted interventions",
    ...
    businessImpact: "Potential healthcare cost reduction of $2.3M annually through data-driven patient care optimization and targeted intervention programs."
  },
  2: {
    ...
    keyFindings: [
      ...
      "Economic impact analysis shows $450M in deferred procedures",
      "Regional healthcare disparities identified across 12 states",
      "Resource allocation optimization saved 15% in operational costs"
    ],
    ...
    businessImpact: "Improved healthcare resource allocation saving $67.5M in operational costs and enabling data-driven policy decisions during crisis management."
  },
  3: {
    ...
    keyFindings: [
      ...
      "Market timing strategies yielded 15% additional returns",
    ...
    businessImpact: "Investment portfolio optimization resulting in 23% improved risk-adjusted returns and reduced portfolio volatility through systematic rebalancing strategies."
  },
  4: {
    ...
    businessImpact: "Revenue growth acceleration of 42% through customer lifetime value optimization and data-driven sales strategy implementation."
  }
};
  ...
  const modalContent = `
    ...
    <div class="modal-section">
      ...
      <div class="dashboard-placeholder">
        <h4>📊 Tableau Dashboard Embedded</h4>
        <p>Interactive visualization showcasing:</p>
        <ul>
...
function initScrollAnimations() {
  ...
  document.querySelectorAll('.project-card, .skill-category, .about-content > *, .competency-item').forEach(el => {
